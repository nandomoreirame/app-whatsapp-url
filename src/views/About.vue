<template>
  <section>
    ...
    <p>O <strong>WhatsApp URL</strong> pode ser utilizado por qualquer pessoa. Basta digitar o <strong>código do País</strong>, <strong>código de área</strong>, o <strong>número da pessoa</strong> e clicar no botão <strong>"Ok, pode enviar a mensagem"</strong></p>
  </section>
</template>
